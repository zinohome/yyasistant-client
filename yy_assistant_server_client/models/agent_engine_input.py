...
if TYPE_CHECKING:
    from ..models.agent_engine_input_config import AgentEngineInputConfig


T = TypeVar("T", bound="AgentEngineInput")


@_attrs_define
class AgentEngineInput:
    """
    Attributes:
        engine (Union[Unset, str]):  Default: 'default'.
        config (Union[Unset, AgentEngineInputConfig]):
        data (Union[File, Unset, str]):  Default: ''.
        conversation_id (Union[Unset, str]):  Default: ''.
    """

    engine: Union[Unset, str] = "default"
    config: Union[Unset, "AgentEngineInputConfig"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_config, Unset):
            ...
            config = AgentEngineInputConfig.from_dict(_config)
        ...
        agent_engine_input.additional_properties = d
        return agent_engine_input
