...
if TYPE_CHECKING:
    from ..models.tts_engine_input_config import TTSEngineInputConfig


T = TypeVar("T", bound="TTSEngineInput")


@_attrs_define
class TTSEngineInput:
    """
    Attributes:
        engine (Union[Unset, str]):  Default: 'default'.
        config (Union[Unset, TTSEngineInputConfig]):
        data (Union[File, Unset, str]):  Default: ''.
    """

    engine: Union[Unset, str] = "default"
    config: Union[Unset, "TTSEngineInputConfig"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_config, Unset):
            ...
            config = TTSEngineInputConfig.from_dict(_config)
        ...
        tts_engine_input = cls(
            engine=engine,
            config=config,
            data=data,
        )

        tts_engine_input.additional_properties = d
        return tts_engine_input
