...
from ...models.body_api_asr_infer_file_yyh_asr_v0_engine_file_post import BodyApiAsrInferFileYyhAsrV0EngineFilePost
...
def _get_kwargs(
    *,
    body: BodyApiAsrInferFileYyhAsrV0EngineFilePost,
...
def sync_detailed(
    *,
    ...
    """Speech To Text Inference (mp3 file)
